...
#include "../../../Common/UIComponent/CamWndFrame.h"
#include "../../../Common/UIComponent/ImageWatchWindow.h"
...
class CImageDetectorDlg;
class CLabelTreeDialog;
class CFileTreeDialog;
class CStreamingDialog;
class CMatchScriptTreeDialog;
extern CImageDetectorDlg *g_imageDetectDlg;
extern CLabelTreeDialog *g_labelTreeDlg;
extern CFileTreeDialog *g_fileTreeDlg;
extern CStreamingDialog *g_streamingDlg;
extern CMatchScriptTreeDialog *g_scriptTreeDlg;
